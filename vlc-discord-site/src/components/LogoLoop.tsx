  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        const isNodeItem = (l: LogoItem): l is NodeLogoItem => 'node' in l;
        ...
        const content = isNodeItem(item) ? (
          ...
          <Image
            className={cx(
              ...
              grayscale && 'grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-300 cursor-pointer',
              !grayscale && '[-webkit-user-drag:none] pointer-events-none',
      ...
      [isVertical, scaleOnHover, renderItem, grayscale]
    );
